...
python $BASE_DIR/main.py \
    ...
    --graph_n_head 6 \
    --depths 6 1 1 1 \
    --save_path "output/nasbench101/neuralformer_1%_centrality_embed/${PRETRAINED}_test_all" \
    --pretrained_path "output/nasbench101/neuralformer_1%_centrality_embed/${PRETRAINED}.pth.tar" \
    --embed_type "nape" \
    --use_extra_token \
