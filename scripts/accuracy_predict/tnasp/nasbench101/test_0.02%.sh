...
python $BASE_DIR/main.py \
    ...
    --graph_n_head 4 \
    --depths 12 \
    --save_path "output/tnasp/nasbench101/neuralformer_0.02%/${PRETRAINED}_test_all/" \
    --pretrained_path "output/tnasp/nasbench101/neuralformer_0.02%/${PRETRAINED}.pth.tar" \
